...
export default function Labelpage() {
  ...
  return (
    <section className="relative w-full min-h-[80vh] mt-20 flex items-center justify-center px-6">
      {/* Right side images */}
      <div className="flex gap-6 absolute right-10 z-20">
        {images.map((img, index) => (
          <motion.img
            ...
            src={img.src}
            alt={img.title}
            className="w-40 h-60 rounded-xl cursor-pointer shadow-lg object-cover"
