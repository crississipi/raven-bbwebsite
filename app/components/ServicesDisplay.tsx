...
const ServicesDisplay: React.FC<Props> =  ({searchValue}) => {
  ...
  return (
    <section id='gallery' className="custom-gallery-bg min-h-screen w-full bg-white px-4 py-20 flex flex-col items-center">
      <img className='absolute opacity-10 items-center ml-350 mt-30 ' src="/burnboxlogo.png" alt="" />
      <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-center text-pink mb-12">Gallery</h1>
      <div className="md:w-4/5 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-1">
